---
title: "Today's Skins"
# VERSION: 2024-11-12-v3 (Removed diagnostics, reordered columns, fixed totals, added time ordering)
format:
  html:
    self-contained: true
    theme: darkly
...
if (nrow(todays_picks) > 0) {
  ...
  matchup_table <- matchup_prep %>%
    ...
    mutate(
      ...
      # For "Not Started" games, use game time for secondary sort
      time_order = if_else(Status == "Not Started", as.numeric(game_time_ct), as.numeric(Sys.time()))
    ) %>%
