  ...
  live_data_final <- bind_rows(live_data_team1, live_data_team2) %>%
    ...
    mutate(
      Team = case_when(
        ...
        str_detect(Team, regex("\\bNew York\\b", ignore_case = TRUE)) & !str_detect(Team, regex("\\bPelicans\\b", ignore_case = TRUE)) ~ "New York Knicks",
        ...
        str_detect(Team, regex("\\bOklahoma\\b", ignore_case = TRUE)) ~ "Oklahoma City Thunder",
        ...
        str_detect(Team, regex("\\bGolden State\\b", ignore_case = TRUE)) ~ "Golden State Warriors",
        str_detect(Team, regex("\\bClippers\\b", ignore_case = TRUE)) ~ "Los Angeles Clippers",
        str_detect(Team, regex("\\bLA Clippers\\b", ignore_case = TRUE)) ~ "Los Angeles Clippers",
        str_detect(Team, regex("\\bLakers\\b", ignore_case = TRUE)) ~ "Los Angeles Lakers",
        str_detect(Team, regex("\\bLA Lakers\\b", ignore_case = TRUE)) ~ "Los Angeles Lakers",
        ...
        str_detect(Team, regex("\\bNew Orleans\\b", ignore_case = TRUE)) ~ "New Orleans Pelicans",
        str_detect(Team, regex("\\bSpurs\\b", ignore_case = TRUE)) ~ "San Antonio Spurs",
        str_detect(Team, regex("\\bSan Antonio\\b", ignore_case = TRUE)) ~ "San Antonio Spurs",
        TRUE ~ Team
      )
    ) %>%
