...
if (use_csv_for_sportsline) {
  ...
  cat("DIAGNOSTIC: After 7 PM - loading expected skins from today's CSV\n")
...
if (nrow(todays_picks) > 0) {
  ...
  matchup_table <- matchup_prep %>%
    ...
    summarise(
      ...
      Won_Skin_2 = if(n() > 1) nth(Won_Skin, 2) else NA, # <-- This is now correct
    ...
    mutate(
      ...
      # *** FIX APPLIED HERE ***
      # This logic now correctly references Won_Skin_2
      ...
      # *** FIX APPLIED HERE ***
      # Added Status == "Final" check to prevent "Yes/No" on in-progress games
      Won_1 = case_when(
        Status != "Final" ~ "",
        is.na(Won_Skin_1) ~ "",
        Won_Skin_1 ~ "✓ Yes",
