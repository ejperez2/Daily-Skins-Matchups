---
title: "Today's Skins"
# VERSION: 2024-11-12-v4 (Fixed gambletron finished games issue, added diagnostics)
format:
  html:
    self-contained: true
    theme: darkly
...
if (exists("todays_results") && nrow(todays_results) > 0) {
  ...
  # Add TOTAL row - FIXED: Calculate sum of Perfect Skins % column
  total_row <- data.frame(
    ...
    `Perfect Skins %` = sum(perfect_skins_calc$`Perfect Skins %`, na.rm = TRUE),
    check.names = FALSE,
    stringsAsFactors = FALSE
  )
